...
class srcApp_KernelProdDebugContainer extends Container
{
    ...
    protected function getTwigService()
    {
        ...
        $d = new \Knp\Bundle\MarkdownBundle\Parser\ParserManager();
        $d->addParser(new \Knp\Bundle\MarkdownBundle\Parser\Preset\Min(), 'min');
        $d->addParser(($this->services['markdown.parser'] ?? ($this->services['markdown.parser'] = new \Knp\Bundle\MarkdownBundle\Parser\Preset\Light())), 'default');
        $d->addParser(new \Knp\Bundle\MarkdownBundle\Parser\Preset\Medium(), 'medium');
        $d->addParser(new \Knp\Bundle\MarkdownBundle\Parser\Preset\Max(), 'max');
